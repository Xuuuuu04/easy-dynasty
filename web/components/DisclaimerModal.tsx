...
export default function DisclaimerModal() {
    ...
    return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-card-bg w-full max-w-md rounded-lg shadow-2xl overflow-hidden border border-border animate-in zoom-in-95 duration-300">
                {/* Header */}
                <div className="bg-accent-main text-white px-6 py-4 flex items-center justify-between">
                ...
                {/* Content */}
                <div className="p-6 md:p-8 space-y-4 max-h-[60vh] overflow-y-auto text-text-sub leading-relaxed text-sm md:text-base">
                    <p>
                ...
                {/* Footer */}
                <div className="bg-bg-main p-6 flex justify-center border-t border-border">
                    <button
                        onClick={handleAgree}
                        className="bg-accent-main hover:bg-accent-light text-white px-8 py-2.5 rounded-full font-medium transition-all shadow-lg hover:shadow-xl active:scale-95 tracking-wide"
                    >
                        我已知晓并同意
                    </button>
                </div>
