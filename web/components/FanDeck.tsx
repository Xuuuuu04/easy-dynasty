      ...
      >
        {Array.from({ length: totalCards }).map((_, i) => {
          ...
          return (
            <div
              key={i}
              className="flex-shrink-0 relative w-[100px] h-[175px] md:w-[120px] md:h-[210px] snap-center -ml-12 md:-ml-16 first:ml-0 transition-all duration-300 transform hover:-translate-y-8 hover:scale-110 hover:z-50 hover:mr-8 cursor-pointer group"
              style={{ zIndex: 1 }}
              onClick={() => !disabled && onCardSelect(i)}
            >
